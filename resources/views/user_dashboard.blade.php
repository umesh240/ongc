    ...
    <div class="container">
      ...
      <div class="event-content">
        <div class="row">
          ...
          <div class="col-md-10 col-10 pl-5 pt-3">
    ...
    <div class="row pt-5 ">
      <div class="col-md-12">
        <div class="user-details p-4">
          <p class="mb-0">
            <b><i class="fa fa-building" style="font-size: 14px;color: #3F70A1;"></i> {{ $hotel_name }}</b><br>{{ $hotel_address }}<br>
            <b>Logistic FPR : </b>{{ $logisticFPR }}<br>
            <b>Hospitality FPR : </b>{{ $hospitalityFPR }}
          </p>
        ...
        <div class="card">
          <div class="card-header">
            <ul class="nav nav-tabs desktop-tabs " role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#travelSchedule" role="tab">Travel Schedule</a>
              </li>
            </ul>
          </div>
